...
namespace Elmah.Io.Client
{
    ...
    public partial class Messages : IServiceOperations<ElmahioAPI>, IMessages
    {
        ...
        public async Task<HttpOperationResponse<MessagesResult>> GetAllWithHttpMessagesAsync(string logId, int? pageIndex = default(int?), int? pageSize = default(int?), string query = default(string), DateTime? fromParameter = default(DateTime?), DateTime? to = default(DateTime?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v3/messages/{logId}").ToString();
            _url = _url.Replace("{logId}", Uri.EscapeDataString(logId));
            List<string> _queryParameters = new List<string>();
            if (pageIndex != null)
            {
                _queryParameters.Add(string.Format("pageIndex={0}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(pageIndex, this.Client.SerializationSettings).Trim('"'))));
            }
            if (pageSize != null)
            {
            ...
            {
                _queryParameters.Add(string.Format("from={0}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(fromParameter, this.Client.SerializationSettings).Trim('"'))));
            }
            if (to != null)
            {
                _queryParameters.Add(string.Format("to={0}", Uri.EscapeDataString(SafeJsonConvert.SerializeObject(to, this.Client.SerializationSettings).Trim('"'))));
            }
        ...
        public async Task<HttpOperationResponse> CreateWithHttpMessagesAsync(string logId, CreateMessage message, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            cancellationToken.ThrowIfCancellationRequested();
            string _responseContent = null;
            if ((int)_statusCode != 200 && (int)_statusCode != 201 && (int)_statusCode != 400 && (int)_statusCode != 401 && (int)_statusCode != 403 && (int)_statusCode != 404 && (int)_statusCode != 429)
            {
                var ex = new HttpOperationException(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                ex.Request = new HttpRequestMessageWrapper(_httpRequest, _requestContent);
        ...
        public async Task<HttpOperationResponse> DeleteAllWithHttpMessagesAsync(string logId, Search search, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if(search != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(search, this.Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
        ...
        public async Task<HttpOperationResponse<Message>> GetWithHttpMessagesAsync(string id, string logId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v3/messages/{logId}/{id}").ToString();
        ...
        public async Task<HttpOperationResponse> HideWithHttpMessagesAsync(string id, string logId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v3/messages/{logId}/{id}/_hide").ToString();
            _url = _url.Replace("{id}", Uri.EscapeDataString(id));
            _url = _url.Replace("{logId}", Uri.EscapeDataString(logId));
            // Create HTTP transport objects
            HttpRequestMessage _httpRequest = new HttpRequestMessage();
