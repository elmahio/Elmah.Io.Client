...
namespace Elmah.Io.Client
{
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Deployment>> GetAllAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v3/deployments"
                    urlBuilder_.Append("v3/deployments");
        ...
        public virtual async System.Threading.Tasks.Task<Deployment> GetAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/deployments/{id}"
                    urlBuilder_.Append("v3/deployments/");
        ...
        public virtual async System.Threading.Tasks.Task CreateAsync(string id, string logId, CreateHeartbeat body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/heartbeats/{logId}/{id}"
                    urlBuilder_.Append("v3/heartbeats/");
    ...
    public partial interface IInstallationsClient
    {
        ...
        /// <param name="body">The installation object to create.</param>
        /// <returns>Installation was created.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        void Create(string logId, CreateInstallation body = null);
        ...
        /// <returns>Installation was created.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateAsync(string logId, CreateInstallation body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public InstallationsClient(string baseUrl, System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = baseUrl;
            _httpClient = httpClient;
        ...
        /// <returns>Installation was created.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        public virtual void Create(string logId, CreateInstallation body = null)
        {
        ...
        /// <returns>Installation was created.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CreateAsync(string logId, CreateInstallation body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (logId == null)
                throw new System.ArgumentNullException("logId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/installations/{logId}"
                    urlBuilder_.Append("v3/installations/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Log>> GetAllAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/logs"
                    urlBuilder_.Append("v3/logs");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ElmahIoClientException("Log contains data and cannot be deleted.", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 429)
                        {
        ...
        public virtual async System.Threading.Tasks.Task DisableAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/logs/{id}/_disable"
                    urlBuilder_.Append("v3/logs/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task EnableAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/logs/{id}/_enable"
                    urlBuilder_.Append("v3/logs/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<string>> DiagnoseAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/logs/{id}/_diagnose"
                    urlBuilder_.Append("v3/logs/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial interface IMessagesClient
    {
        ...
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        void FixAll(string logId, Search body = null);
        ...
        /// <returns>Messages where marked as fixed.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task FixAllAsync(string logId, Search body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<MessagesResult> GetAllAsync(string logId, int? pageIndex = null, int? pageSize = null, string query = null, System.DateTimeOffset? from = null, System.DateTimeOffset? to = null, bool? includeHeaders = null, string searchAfter = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('?');
                    if (pageIndex != null)
                    {
        ...
        public virtual async System.Threading.Tasks.Task<Message> GetAsync(string id, string logId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}/{id}"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Messages where marked as fixed.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        public virtual void FixAll(string logId, Search body = null)
        {
            System.Threading.Tasks.Task.Run(async () => await FixAllAsync(logId, body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }
        ...
        /// <returns>Messages where marked as fixed.</returns>
        /// <exception cref="ElmahIoClientException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task FixAllAsync(string logId, Search body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (logId == null)
                throw new System.ArgumentNullException("logId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}/_fix"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task HideAsync(string id, string logId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}/{id}/_hide"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task FixAsync(string id, string logId, bool? markAllAsFixed = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}/{id}/_fix"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CreateBulkMessageResult>> CreateBulkAsync(string logId, System.Collections.Generic.IEnumerable<CreateMessage> body = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/messages/{logId}/_bulk"
                    urlBuilder_.Append("v3/messages/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task CreateOrUpdateAsync(string logId, System.Uri path, FileParameter sourceMap, FileParameter minifiedJavaScript, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/sourcemaps/{logId}"
                    urlBuilder_.Append("v3/sourcemaps/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<UptimeCheck>> GetAllAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "v3/uptimechecks"
                    urlBuilder_.Append("v3/uptimechecks");
    ...
    public partial class AssemblyInfo
    {
        ...
        public static AssemblyInfo FromJson(string data)
        {
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<AssemblyInfo>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class ConfigFile
    {
        ...
        public static ConfigFile FromJson(string data)
        {
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ConfigFile>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class CreateInstallation
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("loggers", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static CreateInstallation FromJson(string data)
        {
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CreateInstallation>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class LoggerInfo
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("configFiles", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static LoggerInfo FromJson(string data)
        {
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<LoggerInfo>(data, new Newtonsoft.Json.JsonSerializerSettings());
